...
import { BlogCard } from '@/components/magicui/blog-card';
import { TagFilter } from '@/components/magicui/tag-filter';
...
export default async function BlogListPage({
  ...
  const locale = appConfig.i18n ? await getLocale() : undefined;
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 md:px-6 bg-background relative pt-10 mt-10">
