...
import { HashScrollHandler } from '@/components/magicui/hash-scroll-handler';
import { PromoContent } from '@/components/magicui/promo-content';
import { ReadMoreSection } from '@/components/magicui/read-more-section';
import { TableOfContents } from '@/components/magicui/table-of-contents';
...
export default async function BlogPost({
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="flex divide-x divide-border relative max-w-5xl mx-auto px-4 md:px-0 z-10">
        <div className="absolute max-w-5xl mx-auto left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] lg:w-full h-full border-x border-border p-0 pointer-events-none" />
